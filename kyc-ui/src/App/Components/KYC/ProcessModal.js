...
export default class InfoModal extends Component {
  constructor(props) {
    ...
    //           <Button type="primary" loading={this.state.processButton} onClick={() => this.handleProcess(record)}>Match</Button>

    //       ) : "Unavailable"}
            
    //         {/* <ProcessModal record={record} /> */}
    //         {/* <InfoModal record={record} /> */}
    //       </div>
    //     )
    //   }
    // }
  ...
  //   if (!this.state.info && this.state.visible && !prevState.visible) {
  //     this.fetchInfo()
  //   }
  // }
    ...
    return (
      <div>
        ...
        <div style={{display : "flex", justifyContent : "space-between"}}>
          <div></div>
          {!this.state.processed ? (
            <Button type="primary" loading={this.state.processButton} onClick={this.handleProcess}>Process</Button>
          ) : <b>Processed!</b>}
        </div>
  ...
  render() {
    return (
      <div>
        <Button type="primary" onClick={this.showModal}>Process</Button>
        <Modal
          title="KYC Info"
