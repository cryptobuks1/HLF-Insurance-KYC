...
import { Row, Menu, Avatar, Dropdown, Icon, Col, message, Modal, Spin } from 'antd';

import { NavLink, Redirect, Link } from 'react-router-dom';
import { loginPath } from '../../Config/LinkGenerator';
import { logout, getCurrentUser } from '../../Models/Auth';
import { CB_ADMIN_LINKS, CLIENT_LINKS, GB_ADMIN_LINKS } from '../../Config/Navbar';
		...
		return (
			<div>
				<div className="Header-Height">
					<Row className="Header-Content" type="flex" justify="space-between" align="center">
						<Col className="Main-Header-Logo">
							<NavLink to={this.getHomeLink()} >
								<h2 style={{ color: "white" }}>AtCash KYC Management</h2>
						...
						<Col className="Main-Header-Avatar">
							<Dropdown overlay={this.renderMenu()}>
								<a className="ant-dropdown-link">
									<Avatar src={'https://www.s10health.com/img/default_user_icon.png'} />
